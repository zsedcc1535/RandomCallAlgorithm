...
public class RandInfo {
    ...
    public String getFamilyName() {
        ...
        if (randNum == 1) {
            ...
            str = (index % 2) == 1 ? familyName2.substring(index, index + 2) :
    ...
    public double getGrade() {
        double number = new Random().nextGaussian()*0.6+2.8;
        ...
        number = b.setScale(3, BigDecimal.ROUND_HALF_UP).doubleValue();
        return number ;
    }
    /**
     * 功能：按照要求生成到勤情况
